		...
		jQuery(function($){
			   ...
			   $("#lt").mask("aaaaaaaaaaaaa");
				...
				<center>
						...
						<?php }else{  ?>
							<p class="lead"><b>Novo Pedido de <?php echo $tipo ?></b></p>
						<?php } ?>
				</center>
				...
				<form name="form1" role="form" class="form-horizontal" action="<?php echo 'pedido_save.php?op=' . $op . '&id=' . $id ?>" method="post" enctype="multipart/form-data" onSubmit="return validaForm1()">
					<div class="row-fluid">						
						...
						<div class="col-md-5 col-sm-5 col-xs-12  padding border-right">
							...
							<div class="col-md-4">
									<label label-default="" for="">Data da Entrega </label>
										<input type="date" name="data_entrega" size="10" value="<?php echo $data_entrega; ?>" class="form-control" tabindex="2" onkeypress="return teclaEnter(this, event)">
								</div>
							<?php } ?>
								<div class="col-md-4">
